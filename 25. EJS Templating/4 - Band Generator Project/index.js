...
app.get("/", (req, res) => {
	...
	res.render("index.ejs", { generateBandName: null });
});
...
app.post("/submit", (req, res) => {
	...
	const randomNumberAdj = Math.floor(Math.random() * adj.length) + 1;
	const randomNumberNoun = Math.floor(Math.random() * noun.length) + 1;

	const generateBandName = {
		generateAdj: adj[randomNumberAdj],
		generateNoun: noun[randomNumberNoun],
	};

	res.render("index.ejs", { generateBandName });
});
